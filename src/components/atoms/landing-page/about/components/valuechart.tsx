...
export default function ValueChart() {
    ...
    const { data, loading, error, latest, change7d } =
        useShowUSDValue('USD', 'EUR', range);
        ...
        <Box sx={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: "4.45px" }}>
                    <Box width="54px" sx={{ background: 'white', borderRadius: "5px", padding: '3px 7px' }}>
                        <H6 sx={{ fontSize: "6.23px", color: "#111", p: 0, textAlign: "center" }}>
                            USD / EUR
                        </H6>
                    </Box>
                    <Box width="22px" sx={{ background: 'white', borderRadius: "5px", padding: '3px 7px' }}>
                        <H6 sx={{ fontSize: "6.23px", color: "#111", p: 0, textAlign: "center" }}>
                            {range}
                        </H6>
                    </Box>
            ...
            <div style={{ width: "100%", height: 120 }}>
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data.map(d => ({ name: d.date, value: d.rate }))}>
                        ...
                        <Line type="monotone" dataKey="value" stroke="#35c2c4" strokeWidth={1} connectNulls />
                    </LineChart>
                </ResponsiveContainer>
            </div>
                ...
                <Box sx={{
                    ...
                    <div
                        style={{
                            ...
                            fontWeight: 400,
                            fontStyle: "italic",
                            color: (change7d && change7d.pct >= 0) ? '#11EFC4' : '#ff6b6b'
                        }}
                    >
