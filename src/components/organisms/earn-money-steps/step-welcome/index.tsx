...
export const StepWelcome = () => {
  ...
  return (
    ...
    >
      ...
      >
        Это подробное видео-обучение, в котором наглядно показана пошаговая
        инструкция по использованию нашей платформы. Рекомендуем посмотреть его,
        чтобы лучше разобраться во всех функциях и возможностях.
      </P>
      <Box
        sx={{
          width: { lg: "80%", md: "80%", xs: "100%", sm: "100%" },
