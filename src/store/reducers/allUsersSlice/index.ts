  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getReferalsUserThunk.fulfilled, (state, action) => {
        ...
        state.lastPage = action.payload.last_page;
        state.total = Math.ceil(action.payload.pagination.total / action.payload.pagination.per_page);
      })
      ...
      .addCase(getReferralOrdersThunk.pending, (state) => {
        state.getReferralOrdersState.loading = true;
      })
